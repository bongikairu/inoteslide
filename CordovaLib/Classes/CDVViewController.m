...
- (void)showSplashScreen
{
    ...
    if(deviceOrientation==UIDeviceOrientationLandscapeLeft) marginer = -20;
    else marginer = 20;
    
    CGPoint center = CGPointMake(((screenBounds.size.width-marginer) / 2), (screenBounds.size.height / 2));
    ...
    if(deviceOrientation==UIDeviceOrientationLandscapeLeft) marginer = -250;
    else marginer = 250;
    
    self.activityView.center = CGPointMake(center.x, center.y+marginer);
